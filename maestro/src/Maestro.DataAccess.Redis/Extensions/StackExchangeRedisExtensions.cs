...
namespace Maestro.DataAccess.Redis.Extensions
{
    /// <summary>
    ...
    public static class StackExchangeRedisExtensions
    {
        ...
        public static T Get<T>(this IDatabase cache, string key)
        {
            ...
            return JsonConvert.DeserializeObject<T>(result.ToString(), new KnownTypeConverter());
        }
        ...
        public static object Get(this IDatabase cache, string key)
        {
            ...
            return JsonConvert.DeserializeObject<object>(result.ToString(), new KnownTypeConverter());
        }
