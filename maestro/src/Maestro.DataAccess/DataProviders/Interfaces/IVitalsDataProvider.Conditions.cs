...
{
    /// <summary>
    /// IVitalsDataProvider.Conditions
    /// </summary>
    public partial interface IVitalsDataProvider
    {
        ...
        /// <returns></returns>
        Task<IList<ConditionResponseDto>> GetConditions(int customerId, string bearerToken);
        ...
        /// <param name="bearerToken">The bearer token.</param>
        /// <returns></returns>
        Task<IList<ConditionResponseDto>> GetPatientConditions(int customerId, Guid patientId, string bearerToken);
