...
namespace Maestro.DomainLogic.Services.Interfaces
{
    ...
    public partial interface IVitalsService
    {
        ...
        /// <param name="bearerToken">The bearer token.</param>
        /// <returns></returns>
        Task<PostResponseDto<Guid>> CreateThreshold(int customerId, CreateThresholdRequestDto request, string bearerToken);
        ...
        /// Search vitals
        /// </summary>
        /// <param name="searchModel">search params</param>
        /// <param name="bearerToken">The bearer token.</param>
        /// <returns></returns>
        Task<PagedResult<MeasurementDto>> GetVitals(SearchVitalsDto searchModel, string bearerToken);
