...
namespace Maestro.DomainLogic.Services.Interfaces
{
    ...
    public interface ICustomersService
    {
        ...
        /// <summary>
        /// Returns the list of customers which belongs to userId
        /// </summary>
        /// <param name="userId">The user identifier.</param>
        /// <param name="bearerToken">The bearer token.</param>
        /// <returns></returns>
        Task<IList<CustomerResponseDto>> GetCustomers(Guid userId, string bearerToken);
        ...
        /// <param name="bearerToken">The bearer token.</param>
        /// <returns></returns>
        CustomerResponseDto GetCustomer(int customerId, string subdomain, string bearerToken);
        ...
        /// <returns></returns>
        Task<IList<CustomerUserRole>> GetCustomerUserRoles(int customerId);
