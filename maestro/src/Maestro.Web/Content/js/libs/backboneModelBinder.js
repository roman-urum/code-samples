...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        if (typeof jQuery === 'undefined') {
            throw 'BackboneModelBinder requires jQuery to be loaded first';
        }
        if (typeof underscore === 'undefined') {
            throw 'BackboneModelBinder requires underscore.js to be loaded first';
        }
        // if (typeof backbone === 'undefined') {
        //     throw 'Backbone ModelBinder requires backbone.js to be loaded first';
        // }
        factory(jQuery, underscore);
    }
}(function ($, _) {

    // if(!Backbone){
    //     throw 'Please include Backbone.js before ModelBinder.js';
    // }
    ...
    ModelBinder.SetOptions = function(options){
        ModelBinder.options = options;
    };

    // Current version of the library.
    ModelBinder.VERSION = '1.2.0';
    ModelBinder.Constants = {};
    ModelBinder.Constants.ModelToView = 'ModelToView';
    ModelBinder.Constants.ViewToModel = 'ViewToModel';
    ...
    _.extend(ModelBinder.prototype, {
        ...
        _setOptions: function(options){
            ...
            if(!this._options['initialCopyDirection']){
                this._options['initialCopyDirection'] = ModelBinder.Constants.ModelToView;
            }
        },
        ...
        _bindModelToView: function () {
            ...
            if(this._options['initialCopyDirection'] === ModelBinder.Constants.ModelToView){
        ...
        _bindViewToModel: function () {
            ...
            if(this._options['initialCopyDirection'] === ModelBinder.Constants.ViewToModel){
            ...
            for (elementBindingCount = 0; elementBindingCount < attributeBinding.elementBindings.length; elementBindingCount++) {
                ...
                for (boundElCount = 0; boundElCount < elementBinding.boundEls.length; boundElCount++) {
                    ...
                    if(!boundEl._isSetting){
                        convertedValue = this._getConvertedValue(ModelBinder.Constants.ModelToView, elementBinding, value);
            ...
            switch (elementBinding.elAttribute) {
                ...
                case 'class':
                    ...
                    if(!_.isUndefined(previousValue) || !_.isUndefined(currentValue)){
                        previousValue = this._getConvertedValue(ModelBinder.Constants.ModelToView, elementBinding, previousValue);
        ...
        _setModel: function (elementBinding, el) {
            ...
            elVal = this._getConvertedValue(ModelBinder.Constants.ViewToModel, elementBinding, elVal);
    ...
    ModelBinder.createDefaultBindings = function(rootEl, attributeType, converter, elAttribute){
