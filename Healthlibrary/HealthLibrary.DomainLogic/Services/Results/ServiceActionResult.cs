...
{
    /// <summary>
    /// Class to handle errors in business logic and
    /// return info about action executing in result.
    /// </summary>
    public class ServiceActionResult<TContent> : ServiceActionResult<ServiceActionResultStatus, TContent>
    {
        public ServiceActionResult(ServiceActionResultStatus status)
            : base(status)
        {
        }

        public ServiceActionResult(ServiceActionResultStatus status, TContent content) 
            : base(status, content)
        {
        }
    }
