...
namespace CustomerService.DataAccess.Migrations
{
    ...
    /// Configuration.
    /// </summary>
    /// <seealso cref="System.Data.Entity.Migrations.DbMigrationsConfiguration{CustomerServiceDbContext}" />
    public sealed class Configuration : DbMigrationsConfiguration<CustomerServiceDbContext>
    {
        /// <summary>
        ...
        /// </remarks>
        protected override void Seed(CustomerServiceDbContext context)
        {
